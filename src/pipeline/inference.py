...
def predict_meta(stats_result: dict, ai_features: dict) -> Optional[dict]:
    ...
    try:
        ...
        if model_1x2:
            ...
            cols_1x2 = ["ai_motivation", "ai_media_pressure", "ai_injury_impact", "ai_cohesion", "ai_style_risk", "proba_home", "proba_draw", "proba_away"]
        ...
        if model_btts:
            ...
            cols_btts = ["ai_motivation", "ai_media_pressure", "ai_injury_impact", "ai_cohesion", "ai_style_risk", "proba_btts"]
        ...
        if model_o15:
            ...
            cols_o15 = ["ai_motivation", "ai_media_pressure", "ai_injury_impact", "ai_cohesion", "ai_style_risk", "proba_over_15"]
        ...
        if model_o25:
            ...
            cols_o25 = ["ai_motivation", "ai_media_pressure", "ai_injury_impact", "ai_cohesion", "ai_style_risk", "proba_over_25"]
